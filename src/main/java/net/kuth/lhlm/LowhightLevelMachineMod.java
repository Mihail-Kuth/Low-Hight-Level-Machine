...
@Mod("lowhight_level_machine")
public class LowhightLevelMachineMod {
	public static final Logger LOGGER = LogManager.getLogger(LowhightLevelMachineMod.class);
	public static final String MODID = "lowhight_level_machine";

	public LowhightLevelMachineMod(IEventBus modEventBus) {
